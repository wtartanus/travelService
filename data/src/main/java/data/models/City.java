...
public class City {
	...
	public static void save(int id, String city, String description, String history) {
		...
		String sql = "INSERT INTO inspirations (id, city, description, history) VALUES(" + id +  ", " + city + ","  + description + "," + history + ");";
		con.executeSet(sql);
	}
	
	public void save() {
		String sql = "INSERT INTO inspirations (id, city, description, history) VALUES(" + this.id + "," + this.city + ", " + this.description + "," + this.history + ");";
	...
	public City getById(int id) {
		ResultSet rs = null;
		City city = null;
		String sql = "SELECT * FROM inpirations Where id =" + id;
	...
	public ArrayList<City> getByCityId(int cityId) {
		ResultSet rs = null;
		String sql = "SELECT * FROM inspirations Where id =" + cityId;
		rs = this.con.executeGet(sql);
	...
	public ArrayList<City> getByCity(String city) {
	   ResultSet rs = null;
	   ArrayList<City> cities = new ArrayList<City>();
	   String sql = "SELECT * FROM inspirations Where city =" + city;
	   rs = this.con.executeGet(sql);
	   try {
		   while(rs.next()) {
	...
	public ArrayList<City> getAll() {
		...
		ResultSet rs = null;
		ArrayList<City> cities = new ArrayList<City>();
	    String sql = "SELECT * FROM inspirations";
	    rs = this.con.executeGet(sql);
		try {
			while(rs.next()) {
			  City city = new City(rs.getInt("id"), rs.getString("city"), rs.getString("description"), rs.getString("history"));
	...
	public void updateById(int id, String city, String description, String history) {
		String sql = "UPDATE inspirations Set city = " + city + ", description = " + description + ", history = "
			      + history + "WHERE id = " + id;
		this.con.executeSet(sql);
	}
	
	public void update() {
		String sql = "UPDATE inspirations Set city = " + this.city + ", description = " + this.description + ", history = "
				      + this.history + "WHERE id = " + this.id;
		this.con.executeSet(sql);
	}
	
	public void deleteById(int id) {
	    String sql = "DELETE FROM inspirations WHERE id = " + id;
	    this.con.executeSet(sql);
	}
	
	public void delete() {
		String sql = "DELETE FROM inspirations WHERE id = " + this.id;
		this.con.executeSet(sql);
	}
	
	public void deleteAll() {
		String sql = "DELETE FROM inspirations";
		this.con.executeSet(sql);
	}
